...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="${param.menu == 'chart' ? 'active' : ''}"><a href="/chart"><i class="fa fa-bar-chart"></i> <span>业务统计</span></a></li>
            <li  class="${param.menu == 'task' ? 'active' : ''}"><a href="task"><i class="fa fa-calendar-check-o"></i> <span>代办事项</span></a></li>
